...
// import skyScrapper from '@/public/Metrohuts_calipha.svg'
...
const page = () => {
  return (
    ...
    {/* <Image src={skyScrapper} height={600} width={600} className=' h-[400px] w-[400px] object-contain' alt='Metrohuts Inc' /> */}
