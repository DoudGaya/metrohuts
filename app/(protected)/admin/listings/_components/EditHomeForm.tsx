...
// import { updateHomeAction } from "@/actions/homes"
import { updateHomeAction } from "@/actions/homes"
import type { Homes } from "@/typings"
...
export function EditHomeForm({ home, onSubmit, onClose }: EditHomeFormProps) {
  ...
  async function handleSubmit(values: z.infer<typeof homeSchema>) {
    ...
    try {
      ...
      if (values.heroImage) {
        ...
        formDataToSubmit.heroImage = home.heroImage
      }
      ...
      if (values.images) {
        ...
        formDataToSubmit.images = home.images
      }

      const data = await updateHomeAction(home.id, formDataToSubmit)
      ...
      toast({
        title: "Error",
        description: "Failed to update home. Please try again.",
        variant: "destructive",
      })
    } finally {
      setIsPending(false)
